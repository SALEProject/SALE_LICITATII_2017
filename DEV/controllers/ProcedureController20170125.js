        ...
        WSres.on('end', function()
          {
            ...
            data = JSON.parse(data);
              ...
              {
                var AdaugaOferta = ' <h2> Adauga Oferta </h2>';
                    ...
                    // if( true )
                      {
                            ...
                            if(moment(Procedure.ClarificationRequestsDeadline).format() > moment().format() )
                            {
                              ...
                              AdaugaClarificare += '<button class="btn btn-success btn-cons form-submit" onclick="alert(\'test up clarificari\')">Upload Clarificari</button>'
                            }
                            if(moment(Procedure.TendersOpeningDate).format() < moment().format() )
                            {
                              console.log("Poate desemna castigator");
                            }
                      ...
                      else
                      {
                        ...
                        {
                          AdaugaOferta += '<button class="btn btn-success btn-cons form-submit" onclick="alert(\'test up oferta\')">Adauga Oferta</button>'
                        }
