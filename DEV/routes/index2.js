...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
       cb(null, req.session.TextUser + Date.now() + path.extname(file.originalname));
  }
});
...
router.get('/api/editProcedure/variables', ProcedureController.getProcedureVariables);
